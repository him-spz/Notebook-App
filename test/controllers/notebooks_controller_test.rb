...
class NotebooksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create notebook" do
    assert_difference("Notebook.count") do
      post notebooks_url, params: { notebook: { description: @notebook.description, name: @notebook.name, user_id: @notebook.user_id } }
    end
  ...
  test "should update notebook" do
    patch notebook_url(@notebook), params: { notebook: { description: @notebook.description, name: @notebook.name, user_id: @notebook.user_id } }
